...
from pipic.extensions import x_reflector_py
...
sim.add_handler(
    name=x_reflector_py.name,
    subject="electron",
    handler=x_reflector_py.handler(location=L / 4 + L / 32, thickness=L / 16),
    data_double=x_reflector_py.data_double(),
)
...
# ===============================SIMULATION======================================
outputFolder = "figs_x_reflector_py"
